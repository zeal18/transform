...
import io.github.zeal18.transform.TransformationError
...
import utest.*
import io.github.zeal18.transform.cats.*
  ...
  val tests = Tests {
    "path of error should capture for" - {
      ...
      "map" - {
        ...
        error.check(
          "",
          "derivation from k: io.github.zeal18.transform.CatsValidatedErrorPathSpec.FooKey to scala.Double is not supported in the Transform!",
        )

        error.check(
          "",
          "derivation from v: io.github.zeal18.transform.CatsValidatedErrorPathSpec.FooValue to scala.Double is not supported in the Transform!",
        )
