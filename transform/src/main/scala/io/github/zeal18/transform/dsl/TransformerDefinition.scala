...
import io.github.zeal18.transform.internal.macros.dsl.TransformerDefinitionWhiteboxMacros

import scala.language.experimental.macros

/** Allows customization of [[io.github.zeal18.transform.Transformer]] derivation
  *
...
final class TransformerDefinition[From, To, C <: TransformerCfg, Flags <: TransformerFlags](
  ...
  /** Use `value` provided here for field picked using `selector`.
    ...
    * @return [[io.github.zeal18.transform.dsl.TransformerDefinition]]
    */
  ...
  /** Build Transformer using current configuration.
    ...
    *
    * @return [[io.github.zeal18.transform.Transformer]] type class instance
    */
