...
import io.github.zeal18.transform.internal.macros.dsl.TransformerFDefinitionWhiteboxMacros

import scala.language.experimental.macros

/** Allows customization of [[io.github.zeal18.transform.TransformerF]] derivation
  *
...
final class TransformerFDefinition[F[+_], From, To, C <: TransformerCfg, Flags <: TransformerFlags](
  ...
  val instances: Map[(String, String), Any],
    ...
    with TransformerDefinitionCommons[
      Lambda[`C1 <: TransformerCfg` => TransformerFDefinition[F, From, To, C1, Flags]],
    ] {
  ...
  /** Use `value` provided here for field picked using `selector`.
    ...
    * @return [[io.github.zeal18.transform.dsl.TransformerFDefinition]]
    */
  ...
  /** Use `f` to calculate the (missing) wrapped coproduct instance when mapping one coproduct into another
    ...
    * @return [[io.github.zeal18.transform.dsl.TransformerFDefinition]]
    */
  def withCoproductInstanceF[Inst](f: Inst => F[To]): TransformerFDefinition[F, From, To, ? <: TransformerCfg, Flags] =
  ...
  /** Build TransformerF using current configuration.
    ...
    *
    * It requires [[io.github.zeal18.transform.TransformerFSupport]] instance for `F` to be
    * available in implicit scope of invocation of this method.
    *
    * When transformation can't be derived, it results with compilation error.
    *
    * @return [[io.github.zeal18.transform.TransformerF]] type class instance
    */
  def buildTransformer[ScopeFlags <: TransformerFlags](implicit
    tfs: TransformerFSupport[F],
    tc: io.github.zeal18.transform.dsl.TransformerConfiguration[ScopeFlags],
