...
import io.github.zeal18.transform.internal.TransformerDerivationError
import io.github.zeal18.transform.internal.PatcherConfiguration
...
trait PatcherMacros extends PatcherConfiguration with TransformerMacros {
  ...
  def genPatcher[T: WeakTypeTag, Patch: WeakTypeTag](
  ...
  ): c.Expr[io.github.zeal18.transform.Patcher[T, Patch]] = {
    ...
    if (!T.isCaseClass || !Patch.isCaseClass) {
      ...
      if (targetMapping.exists(_.isLeft)) {
        ...
        val resultTree = q"""
           new _root_.io.github.zeal18.transform.Patcher[$T, $Patch] {
        ...
        c.Expr[io.github.zeal18.transform.Patcher[T, Patch]](resultTree)
      }
    }
  }
