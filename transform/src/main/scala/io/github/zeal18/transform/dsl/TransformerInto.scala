...
import io.github.zeal18.transform.internal.macros.dsl.TransformerIntoWhiteboxMacros

import scala.language.experimental.macros

/** Provides DSL for configuring [[io.github.zeal18.transform.Transformer]]'s
...
final class TransformerInto[From, To, C <: TransformerCfg, Flags <: TransformerFlags](
  ...
  /** Use `f` to calculate the (missing) wrapped coproduct instance when mapping one coproduct into another
    ...
    * @return [[io.github.zeal18.transform.dsl.TransformerFInto]]
    */
  def withCoproductInstanceF[F[+_], Inst](f: Inst => F[To]): TransformerFInto[F, From, To, ? <: TransformerCfg, Flags] =
