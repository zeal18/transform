...
import io.github.zeal18.transform.examples.*
import utest.*
  ...
  val tests = Tests {
      ...
      "field is added to the target" - {
        ...
        "not compile if source for the target fields is not provided" - {
          ...
          compileError("Bar(3, (3.14, 3.14)).transformInto[Foo]")
            .check("", "no accessor named y in source type io.github.zeal18.transform.DslSpec.Bar")
        }
        ...
        "support default values for Options" - {
          ...
          "not compile if .enableOptionDefaultsToNone is missing" - {
            compileError("""SomeFoo("foo").into[Foobar].transform ==> Foobar("foo", None)""")
              .check("", "The Transform can't derive transformation from SomeFoo to Foobar")
          }
          ...
          "not compile if default values are disabled and no .enableOptionDefaultsToNone" - {
            compileError("""SomeFoo("foo").into[Foobar2].disableDefaultValues.transform""")
              .check("", "The Transform can't derive transformation from SomeFoo to Foobar2")
          }
        }
    ...
    "support default parameters" - {
      ...
      "not compile when default parameter values are disabled" - {
        ...
        """).check("", "The Transform can't derive transformation from Foo to Bar")

        compileError("""
          Baah(10, Foo(300)).into[Baahr].disableDefaultValues.transform
        """).check("", "The Transform can't derive transformation from Baah to Baahr")
      }
    }
      ...
      "between different types: without implicit" - {
        compileError("""
            ...
            user.into[UserPL].withFieldRenamed(_.name, _.imie)
                ...
                .transform
          """).check("", "The Transform can't derive transformation from User to UserPL")
      }
    }
    ...
    "support common data types" - {
      ...
      "support scala.Option" - {
        ...
        compileError("""Some("foobar").into[None.type].transform""")
          .check("", "derivation from some: scala.Some to scala.None is not supported in the Transform!")
        case class BarNone(value: None.type)
        compileError("""Foo("a").into[BarNone].transform""").check(
          "",
          "value: scala.None - can't derive transformation from value: java.lang.String in source type io.github.zeal18.transform.DslSpec.Foo",
        )
      }
      ...
      "support automatically filling of scala.Unit" - {
        ...
        compileError("""Buzz("a").transformInto[ConflictingFooBuzz]""").check(
          "",
          "value: scala.Unit - can't derive transformation from value: java.lang.String in source type io.github.zeal18.transform.DslSpec.Buzz",
        )
      }
    ...
    "support with .enableUnsafeOption" - {
      ...
      "transforming fixed None type does not compile" - {
        compileError("""None.into[String].enableUnsafeOption.transform""")
          .check("", "derivation from none: scala.None to java.lang.String is not supported in the Transform!")
        ...
        compileError("""Foobar(None).into[Foobar2].enableUnsafeOption.transform""").check(
          "",
          "x: java.lang.String - can't derive transformation from x: scala.None in source type io.github.zeal18.transform.DslSpec.Foobar",
        )
      }
    }
    ...
    "support using method calls to fill values from target type" - {
      case class Foobar(param: String) {
        ...
        private[transform] def priv: String = "priv"
      }
      ...
      "method is disabled by default" - {
        ...
        compileError("""Foobar("param").into[Foobar5].transform""").check(
          "",
          "method1: java.lang.String - no accessor named method1 in source type io.github.zeal18.transform.DslSpec.Foobar",
          "method2: java.lang.String - no accessor named method2 in source type io.github.zeal18.transform.DslSpec.Foobar",
          "method3: java.lang.String - no accessor named method3 in source type io.github.zeal18.transform.DslSpec.Foobar",
          "method4: java.lang.String - no accessor named method4 in source type io.github.zeal18.transform.DslSpec.Foobar",
          "method5: java.lang.String - no accessor named method5 in source type io.github.zeal18.transform.DslSpec.Foobar",
          "There are methods in io.github.zeal18.transform.DslSpec.Foobar that might be used as accessors for `method1`, `method2`, `method3` and 2 other methods fields in io.github.zeal18.transform.DslSpec.Foobar5. Consider using `.enableMethodAccessors`.",
        )
      }
      ...
      "protected and private methods are not considered (even if accessible)" - {
        ...
        compileError("""Foobar("param").into[Foo2].enableMethodAccessors.transform""").check(
          "",
          "protect: java.lang.String - no accessor named protect in source type io.github.zeal18.transform.DslSpec.Foobar",
          "priv: java.lang.String - no accessor named priv in source type io.github.zeal18.transform.DslSpec.Foobar",
        )
      }
    }
    ...
    "support sealed hierarchies" - {
      ...
      "fail on ambiguous targets" - {
        ...
        error.check(
          "",
          "coproduct instance Triangle of io.github.zeal18.transform.examples.shapes5.Shape is ambiguous",
          "coproduct instance Rectangle of io.github.zeal18.transform.examples.shapes5.Shape is ambiguous",
        )

        assert(
          !error.msg.contains(
            "coproduct instance Circle of io.github.zeal18.transform.examples.shapes5.Shape is ambiguous",
          ),
        )
      }
    }
    ...
    "transform between case classes and tuples" - {
      ...
      "handle tuple transformation errors" - {
        ...
        """).check(
          "",
          "source tuple scala.Tuple2 is of arity 2, while target type io.github.zeal18.transform.DslSpec.Foo is of arity 3; they need to be equal!",
        )
        ...
        """).check(
          "",
          "source tuple io.github.zeal18.transform.DslSpec.Foo is of arity 3, while target type scala.Tuple5 is of arity 5; they need to be equal!",
        )
    ...
    "support scoped transformer configuration passed implicitly" - {
      ...
      "compile error when optionDefaultsToNone were disabled locally" - {
        ...
        """).check("", "The Transform can't derive transformation from Source to Target")
      }
    }
  }
}
