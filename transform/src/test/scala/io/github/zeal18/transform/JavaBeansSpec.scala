    ...
    "reading from Java beans" - {
      ...
      "not compile when bean getter lookup is disabled" - {
        ...
        compileError(
          ...
          "",
          "The Transform can't derive transformation from io.github.zeal18.transform.JavaBeanSourceWithFlag to io.github.zeal18.transform.CaseClassWithFlag",
        )
      }
      ...
      "not compile when matching an is- getter with type other than Boolean" - {
        ...
        compileError("""
          ...
          """).check("", "The Transform can't derive transformation from MistypedSource to MistypedTarget")
      }
    }
    ...
    "writing to Java beans" - {
      ...
      "not compile when bean setters are not enabled" - {
        ...
        compileError("""
          ...
          """).check(
          "",
          "The Transform can't derive transformation from io.github.zeal18.transform.CaseClassWithFlag to io.github.zeal18.transform.JavaBeanTarget",
        )
      }
      ...
      "not compile when accessors are missing" - {
        ...
        compileError("""
          ...
          """).check(
          "",
          "The Transform can't derive transformation from io.github.zeal18.transform.CaseClassNoFlag to io.github.zeal18.transform.JavaBeanTarget",
        )
      }
      ...
      "not compile when method accessor is disabled" - {
        compileError("""
          ...
          """).check(
          "",
          "The Transform can't derive transformation from io.github.zeal18.transform.CaseClassWithFlagMethod to io.github.zeal18.transform.JavaBeanTarget",
          "io.github.zeal18.transform.JavaBeanTarget",
          "flag: scala.Boolean - no accessor named flag in source type io.github.zeal18.transform.CaseClassWithFlagMethod",
          "There are methods in io.github.zeal18.transform.CaseClassWithFlagMethod that might be used as accessors for `flag` fields in io.github.zeal18.transform.JavaBeanTarget. Consider using `.enableMethodAccessors`.",
