...
import io.github.zeal18.transform.examples.trip.*
import io.github.zeal18.transform.utils.EitherUtils.*
import io.github.zeal18.transform.utils.OptionUtils.*
import utest.*
  ...
  val tests = Tests {
    ...
    "implicit conflict resolution" - {
      ...
      "fail compilation if there is unresolved conflict" - {
        ...
        compileError("""
          ...
          """).check(
          "",
          "Ambiguous implicits while resolving the Transform recursive transformation",
    ...
    "support config type-aliases" - {
      type VTransformer[A, B] =
        io.github.zeal18.transform.TransformerF[VTransformer.F, A, B]
      ...
      object VTransformer {
        ...
        def define[From, To]: Definition[From, To] =
          io.github.zeal18.transform.TransformerF.define[F, From, To]
      }
