  ...
  val tests = Tests {
    "error path should capture for" - {
      ...
      "map" - {
        ...
        error.check(
          "",
          "derivation from k: java.lang.String to scala.Double is not supported in the Transform!",
        )

        error.check(
          "",
          "derivation from v: java.lang.String to scala.Double is not supported in the Transform!",
        )
      }
